...
const Landing = () => {
  return (
    <div>
      <Navbar />
      <div className="mt-44 mono flex flex-col justify-center items-center">
        <div className="w-1/2">
        ...
        <div className="w-1/2 relative">
          ...
          <div className="flex gap-5 mono justify-center text-xl ">
            <h1 className="cursor-pointer hover:font-bold">Popular Now:</h1>
          ...
          <div className="pt-20 mono text-xl flex flex-col gap-2 items-center font-bold">
            ...
            <button className="w-[200px] h-[50px] bg-transparent hover:bg-black hover:text-white transition-all ease-in-out duration-300 border-2 border-black rounded-full">
              Register Now
            </button>
            <img
